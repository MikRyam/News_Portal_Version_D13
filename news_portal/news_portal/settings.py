...
SERVER_EMAIL = '___@yandex.ru'  # это будет у нас вместо аргумента FROM в массовой рассылке

# DEFAULT_FROM_EMAIL = '___@yandex.ru'  # здесь указываем уже свою ПОЛНУЮ почту, с которой будут отправляться письма
...
# Filesystem cashing  кэширование через файловую систему
CACHES = {
    'default': {
